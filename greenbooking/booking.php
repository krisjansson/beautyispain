         ...
         <div class="container mt-5">
          ...
          <section class="mb-5 d-flex flex-wrap justify-content-center dato-valg">
            ...
            <?php
                ...
                while ($stmt->fetch()) {
                    ...
                    ?><form action="<?=htmlspecialchars($_SERVER["PHP_SELF"])?>" method="post" enctype="multipart/form-data" class="needs-validation my-4 mx-4" novalidate>
                            ...
                            <h2><input type="text" value="<?php echo $date ?>" class="form-control bg-f5 disabled"></h2>
                            <input name="startday1" type="hidden" value="<?php echo $startHole ?>" class="form-control bg-f5 disabled">
                            ...
                            <div class="form-group">
                                ...
                                <div>
                                        ...
                                        <input type="text" value="<?php echo $durInMin ?>" class="form-control bg-f5 disabled">
                                        <input name="behandlingstid" type="hidden" value="<?php echo $onlyBhtime ?>" class="form-control bg-f5 disabled">
            ...
            if (isset($_POST['form_timeselect'])){
                ...
                $date2 = substr($choosenday, 0, 10);
                $onlyTime = substr($choosenday, 11);
                ?>
                    ...
                    <section id="bestilling-detaljer" class="col-md-4 mt-4">        
                        ...
                        <div class="form-group">
                            ...
                            <div class="input-group date" id="datetimepicker5">
                                <h2><input id="dato" type="text" value="<?php echo $date2 ?>" class="form-control" required/></h2>
                                <input id="dato" type="hidden" name="date" value="<?php echo $choosenday ?>" class="form-control" data-target="#datetimepicker5" required/>
                        ...
                        <div class="form-group">
                            ...
                            <div class="input-group date" id="datetimepicker3">
                                <h2><input id="tidspunkt" type="text" value="<?php echo $onlyTime ?>" class="form-control datetimepicker-input" required/></h2>
                                <input id="tidspunkt" type="hidden" name="startselect4" value="<?php echo $treatmentStart ?>" class="form-control datetimepicker-input" data-target="#datetimepicker3" required/>
 ...
 <!-- SCRIPTS -->
    ...
    <script>
        $(document).ready(function(){
            ...
            $.fn.datepicker.defaults.language = 'DK';
        });
    </script>
    <!-- DATE TIME PICKER UI -->
